...
class OWL():
    def __init__(self):
        ...
        for token in open("data/tokens.txt"):
            if token != '':
                self.tokens.append(
                    token.replace("\n", "").replace('\r\n',
                                                    '').replace('\r', ''))
        ...
        resp = input()
        if resp.lower() == 'y':
            for proxy in open("data/proxies.txt"):
                if proxy != '':
                    split = proxy.replace("\n", "").replace('\r\n',
                                                    '').replace('\r', '').split(":")
                    if len(split) == 2:
            ...
            if resp.lower() == 'y':
                ...
                while added != len(self.checked):
                    ...
                    print(
                        ...
                        + Fore.BLUE + '[' + Fore.CYAN + '/' +
                        Fore.BLUE + '] ' + Fore.CYAN +
                        f'Saved new tokens in data/checked.txt.' +
                        Fore.RESET)
                    print(
                        '                                       '
                        + Fore.BLUE + '[' + Fore.CYAN + '/' +
                ...
                while added != len(self.checked):
                    ...
                    print(
                        ...
                        + Fore.BLUE + '[' + Fore.CYAN + '/' +
                        Fore.BLUE + '] ' + Fore.CYAN +
                        f'Replaced with new tokens in data/tokens.txt.' +
                        Fore.RESET)
                    print(
                        '                                       '
                        + Fore.BLUE + '[' + Fore.CYAN + '/' +
    ...
    async def screen12(self):
        try:
            await self.rpc.update(state="", details="Sexy Spammer", large_image="default")
        except:
            pass
        clear()
